...
void ricorrenza (int vettore[], int n, int counter[]) {
...
int max_ricorrenza (int vettore[], int n) {
...
int magg_min_arrey (int vettore[], int vettore2[], int n) {
...
int magg_min_arrey2 (int vettore[], int vettore2[], int n) {
...
void print_arrey (int vettore[], int lung) {
